...
public abstract class Char extends Actor {
    ...
    public boolean attack(Char enemy, float dmgMulti, float dmgBonus, float accMulti) {
        ...
        if (enemy.isInvulnerable(getClass())) {
            ...
            if (buff(CrimsonBurning.class) != null) new CrimsonBurning().attachTo(enemy);
    ...
    public void die(Object src) {
        ...
        Boolean remain = buff(WalkingBomb.class) != null;
        if (src instanceof Hero) {
            if (((Hero) src).buff(ExplosionReady.class) != null) {
                remain = true;
            }
        }
        ...
        if (buff(WalkingBomb.class) != null) {
            corpse.bomb = true;
            buff(WalkingBomb.class).detach();
        }
