...
import com.shatteredpixel.shatteredpixeldungeon.tiles.sheets.DungeonTileSheet;
...
public class GameScene extends PixelScene {
    ...
    public void create() {
        ...
        water = new SkinnedBlock(
            ...
            public void draw() {
                time+=0.006;
                ((NoosaScriptFlexWater)script()).uTime.value1f(time);
                super.draw();
            }
            ...
            {
                return NoosaScriptFlexWater.get();
            }
        };
        ...
        if (dropped != null) {
            for (Item item : dropped) {
                ...
                if (item instanceof Potion) {
                    ...
                    Dungeon.level.plant((Plant.Seed) item, pos, Random.Int(100)==0);
