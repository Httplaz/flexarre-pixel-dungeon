...
public class Item implements Bundlable {
    ...
    public static final String AC_MAKE_BOMB = "MAKE_BOMB";
    ...
    public ArrayList<String> actions(Hero hero) {
        ...
        if (hero.stand == HeroStand.KILLER_QUEEN && hero.buff(ExplosionReady.class) == null && canBeBomb)
            actions.add(AC_MAKE_BOMB);
        return actions;
    }
    ...
    public void execute(Hero hero, String action) {
        ...
        } else if (action.equals(AC_MAKE_BOMB)) {
            Buff.affect(hero, ExplosionReady.class);
            unique = false;
            bomb = true;
        }
    }
    ...
    public String desc() {
        return Messages.get(this, "desc") + (bomb ? "\nThis is a Killer Queen bomb." : "");
    }
